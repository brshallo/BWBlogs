...
We grow-up learning proportions/risks/probabilities... we encounter them when a teacher gives a grade on a test or a doctor describes the risk of an illness. 'Odds,' on the other hand, you might imagine as relevant only to the shady domains of gambling and advanced statistics. In this post, I'll describe some of the excellent qualities of odds and odds ratios. My hope is you finish this post with an understanding of the basic concept, some hints at a general class of problems where the 'odds way of defining a problem' can be useful, and a simple heuristic for how to communicate in terms of 'odds' with the rest of the world[^1].

[^1]: Fun fact: according to Wikipedia humanity conceived of odds far before probability. Check-out this quote from Shakespeare's *Henry IV, Part II* dating back to the 1500's: 
    
    >"Knew that we ventured on such dangerous seas  
    >That if we wrought out life 'twas ten to one;"  
    
    Doesn't that have a better ring to it than "twas one out of eleven."

# Odds & probabilities with 2 potential outcomes

Picture a bag with 5 red marbels and 2 blue marbles that has been mixed thoroughly. 
...
Odds could be used to represent the ratio between red and blue marbles (or blue and red marbles). Probability could represent the fraction of all marbles that are red (or the fraction of all marbles that are blue). Note that while probability is limited to the domain of 0 to 1, odds can take any positive rational number.
